...
$completed_projects_forum_idx, $deleted_projects_forum_idx, $preceding_proofer_restriction,
$aspell_executable, $aspell_prefix, $api_storage_keys, $forums_phpbb_table_prefix, $site_name, $testing;
