...
class ApiTest extends ProjectUtils
{
    ...
    public function test_info_for_previous_proofreaders()
    {
        ...
        $this->assertEquals([['P1', $this->TEST_USERNAME]], $response['round_info_array']);
        ...
        $this->assertEquals([['P1', $this->TEST_USERNAME], ['P2', $this->TEST_OLDUSERNAME]], $response['round_info_array']);
    }
