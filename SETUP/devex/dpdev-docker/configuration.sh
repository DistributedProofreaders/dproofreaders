...
_JSON_USERS=/var/www/html/d/json_forum/users.json
_JSON_POSTS=/var/www/html/d/json_forum/posts.json
...
_PROJECTS_DIR=$_DYN_DIR/projects
_PROJECTS_URL=$_DYN_URL/projects
...
_FORUMS_PROJECT_WAITING_IDX=0
_FORUMS_PROJECT_AVAIL_IDX=0
_FORUMS_PROJECT_PP_IDX=0
_FORUMS_PROJECT_POSTED_IDX=0
