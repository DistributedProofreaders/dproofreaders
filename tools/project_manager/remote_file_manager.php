...
function do_showupload()
{
    ...
    $form_content .= "<p>" . _("Your browser supports uploading large files (up to 1GB) via javascript. If the download fails for some reason, uploading the file again will pick up where it left off.") . "</p>";
