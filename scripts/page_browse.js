    ...
    async function showCurrentMode() {
        ...
        switch (displayMode) {
            ...
            case "imageText": {
                ...
                theSplitter.setSplitDirCallback.push(textWidget.setup);
                pageControlDiv.append(...theSplitter.buttons, resetButton, imageButton, textButton, ...pageControls, roundControl);
