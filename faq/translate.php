...
<p>If you want to translate the user interface into a new language, or want to refine an existing translation, contact a site administrator.</p>
...
<p>Note that locales can come in various different charcter sets, eg:</p>
<ul>
    <li>en_US  (actually ISO-8859-1, ie: Latin-1)</li>
    <li>en_US.utf8</li>
</ul>

<p>The DP code currently requires the ISO-8859-1 character set so you must have the ISO-8859-1 version of the locale installed. CentOS/Redhat systems install locales with both ISO-8859-1 and UTF-8 character sets by default. Ubuntu systems often don't have the ISO-8859-1 character sets, but you can generate them with <tt>locale-gen</tt>, eg: <tt>locale-gen es_MX</tt>.
...
<p>The DP code comes with a set of translations provided by the community at pgdp.net. These are in the SETUP/locale directory. The translations may not be complete if strings were added or changed in the code since the translation was done. Strings that haven't been translated will display in English.</p>
...
<blockquote>
<pre>
INSERT INTO usersettings SET username='&lt;username&gt;', setting='site_translator', value='yes';
</pre>
</blockquote>
...
<h3>PO Editors</h3>
<p>To work with DP code translations, you need to download and install a PO editor. This is a tool that allows working with PO files, also known as message files, and ensures that the file is in the correct format and character set. Here are links to some common editors:</p>
<ul>
...
<ol>
    ...
    <li>(optional) Merge the current PO file with the most recent template. This is a good practice if the template and current PO file have wildly different dates.</li>
