...
echo "<p>" . sprintf(_("A <strong>thorn</strong> is a letter that was used in Old and Middle English, and is still used in Icelandic.  It usually represents the \"th\" sound.  In %s projects, it usually looks like:"), SiteConfig::get()->site_abbreviation) . "</p>\n";
