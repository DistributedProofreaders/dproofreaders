...
theme("Most Requested Books", "header");

echo "<br><h2 style='color: $theme[color_headerbar_bg];'>Most Requested Books</h2><br>\n
...
echo "<br><br><h3 style='color: $theme[color_headerbar_bg];'>Most Requested Books Being Proofread</h2><br>\n";
...
echo "<br>\n";
echo "<br><br><h3 style='color: $theme[color_headerbar_bg];'>Most Requested Books In Post-Processing</h2><br>\n";
...
echo "<br>\n";
echo "<br><br><h3 style='color: $theme[color_headerbar_bg];'>Most Requested Books Posted to Project Gutenberg</h2><br>\n";
