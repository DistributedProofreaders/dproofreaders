...
theme("Books Checked Out for Post Processing Verification", "header");

if ($order == 'default'){
       $order ='checkedoutby, modifieddate';
  }

       echo "<a href =\"ppv_checkedout.php\">Default Sort Order </a>is Checked Out To and then Date Last Modified";
    ...
    echo "<td><b>#</b></td><td><b>Name of Work</b></td>
          <td><b><a href =\"ppv_checkedout.php?order=checkedoutby\">Checked Out To</b></td>
          <td><b><a href = \"ppv_checkedout.php?order=modifieddate\">Date Last Modified</a></b></td><td>User Last
Login</td><tr>";
