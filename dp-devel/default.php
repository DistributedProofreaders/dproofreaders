...
<? echo _("The first step to take to help us out would be to <a href='accounts/addproofer.php'>register</a> to be a new proofreader. (A 'Register' link also appears at the top of the screen.)  After you register be sure to read over both the email you receive as well as  <a href='{$code_url}/faq/faq_central.php'>FAQ Central</a> which provides helpful resources on how to proofread.  (See also the 'Help' at the top of any screen.)  After you have registered &amp; read through some of the intro documents choose an interesting-looking book from our Current Projects and try proofreading a page or two."); ?></p>
