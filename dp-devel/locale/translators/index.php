...
if (empty($_REQUEST['lang']) && empty($func)) {
	...
	echo _("We currently have the following languages available for translation.  These languages are based upon the ISO-3166 list and if you do not see a language you would like to proof available please click <a href='new_lang.php?func=newlang'>here</a>.");
