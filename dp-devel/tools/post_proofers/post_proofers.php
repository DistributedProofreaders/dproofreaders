...
echo "<p>Here is a <a href='$siteurl/faq/post_proof.php'><b>Post Proof FAQ</b></a> that details all of the steps that we normally take to post proof an etext. There is a <a href='$forums_url/viewforum.php?f=3'>forum</a> to post all your questions. If no books are listed that means no work is currently available, please check back later!";
