...
<body>
<p>Below are words that have been flagged by the spellchecker as invalid but appear frequently in the project. The list was generated by accesing the text of the book from the most recent round of each page and running it through the spellchecker using both the system and the project dictionaries. Vet the list and consider adding frequentely used valid words to the project's valid word list by copy and pasteing them into the Valid Words box when editing the project.</p>
