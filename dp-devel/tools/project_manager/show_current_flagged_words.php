...
<html>
<head>
<title>Project Bad Word List</title>
</head>
<body>
<p>The list below contains words from this project that the spellchecker currently considers bad. The list was generated by accessing the most recent text of each page and running it through the spellchecker, using the current dictionaries/wordlists at the external, site, and project levels. If you find words in this list that should be considered good, consider adding them to the project's good words list by copying them into the Good Words box when editing the project. (Take care not to overwrite any words that are already in the box.)</p>
