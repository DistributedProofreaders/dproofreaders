...
list($instances_left,$messages,$instances_changed_to,$instances_changed,$percent_changed) = _get_word_list($projectid);
...
if($format == "file") {
    ...
    echo "\r\n";
    echo _("Format: [word] - [% changed] - [changed to] - [# changed] - [# left] - [# total]") . "\r\n";
    echo "\r\n";
...
$instances_changed_to["[[TITLE]]"]=_("Changed to");
