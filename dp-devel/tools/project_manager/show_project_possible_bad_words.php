...
if($format == "file") {
    ...
    echo _("Candidates for project's Bad Words List"). "\r\n";
    ...
    $title = _("Download candidates for project's Bad Words List");
    $page_text = _("A list of the words from this project that are found in the site's Possible Bad Words files is avaiable for download.");
} elseif($format == "html") {
    $title = _("Candidates for project's Bad Words List");
...
$page_text = _("Words in the Possible Bad Words file are frequently-encountered stealth scannos, and therefore they would not be flagged by the external spell check. The existence of these words in this project does not mean these words are stealth scannos, just that they might be.");
echo "<p>$page_text</p>";
...
echo_page_instruction_reiteration_text( "bad" );
