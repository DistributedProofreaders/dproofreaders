...
<?php
  ...
  echo '<li><a href="http://www.newadvent.org/cathen/" target="_blank">' . _('Catholica Encyclopedia') . '</a></li>';
  ...
  echo '<li><a href="http://www.britannica.com/" target="_blank">' . _('Encyclopædia Britannica') . '</a> (' .
