...
<ul>
  <li><a href="#x">What's up with the new spellcheck interface?</a></li>
  <li><a href="#x">What's with 'Good' and 'Bad' words?</a></li>
  <li><a href="#x">Where do misspelled (Flag) words come from?</a></li>
  <li><a href="#x">Can you give me a simple example of how the levels work to Flag words for the proofer to correct or accept?</a></li>
  <li><a href="#x">How does capitalization affect the word lists?</a></li>
</ul>
<h3>Proofer Questions</h3>
<ul>
  <li><a href="#x">What's the AW button and what does it do?</a></li>
  <li><a href="#x">Why don't all Bad words have an AW button?</a></li>
  <li><a href="#x">How do I get a word added to the project dictionary?</a></li>
  <li><a href="#x">How can I check the page against the dictionary for a different language?</a></li>
</ul>
<h3>Project Manager Questions</h3>
<ul>
  <li><a href="#x">How do I view Site Word Lists?</a></li>
  <li><a href="#x">How do I view Project Word Lists?</a></li>
  <li><a href="#x">What do I have to do? How do I manage project words?</a></li>
  <li><a href="#x">Can I add additional language dictionaries to the spellchecker?</a></li>
</ul>

<hr>

<h2>General Questions</h2>
<h3><a name="x"></a>What's up with the new spellcheck interface?</h3>
...
<h3><a name="x"></a>What's with 'Good' and 'Bad' words?</h3>
...
<h3><a name="x"></a>Where do misspelled (Flag) words come from?</h3>
...
<h3><a name="x"></a>Can you give me a simple example of how the levels work to Flag words for the proofer to correct or accept?</h3>
...
<h3><a name="x"></a>How does capitalization affect the word lists?</h3>
...
<h3><a name="x"></a>What's the AW button and what does it do?</h3>
...
<h3><a name="x"></a>Why don't all Bad words have an AW button?</h3>
...
<h3><a name="x"></a>How do I get a word added to the project dictionary?</h3>
...
<h3><a name="x"></a>How can I check the page against the dictionary for a different language?</h3>
...
<h3><a name="x"></a>How do I view Site Word Lists?</h3>
...
<h3><a name="x"></a>How do I view Project Word Lists?</h3>
...
<h3><a href="x"></a>Can I add additional language dictionaries to the spellchecker?</h3>
...
<h3><a name="x"></a>What do I have to do? How do I manage project words?</h3>
