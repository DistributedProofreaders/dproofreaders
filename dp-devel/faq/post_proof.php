...
<p>Check the <a href="<? echo $projects_forum_url ?>">Project Questions and Comments Forum</a> for your book's title to see what proofers have been saying about it.  Again, this might alert you of issues which might make the work more difficult than you had realized.</p>
...
<li>Look for comments and questions proofers had while proofing your book in the <a href="<? echo $projects_forum_url ?>">Project Questions and Comments Forum</a>.<br>
...
<p>If the text really should be produced in a version that will allow future readers to view the images, and you are unable or unwilling to do the work to put it in such a version, return it and post your concerns in the <a href="<? echo $post_processing_forum_url ?>">Post-Processing Forum</a>.</p>
<br>
<h3><a name="Sidenotes">Sidenotes</a></h3>
<br>
<h4>These [Sidenote] tags seem redundant!</h4>

<p>In most cases, sidenotes add a bit of summary or description to the text, but, in very rare cases, the sidenotes add nothing to the book and will be an annoyance rather than a help.  If your book fits this mold, consider leaving out the sidenotes.  BUT, think long and hard about this, as it is altering the text of the original.  Email the Project Manager and/or post in the <a href="<? echo $post_processing_forum_url ?>">Forums</a> for a second opinion before taking this step.</p>
<br>
...
<p>Many languages, like Arabic and Hebrew, are difficult to transcribe without an intimate knowledge of the language.  If your text contains snippet
 s of such a language and you don't have the knowledge to transcribe it yourself, try posting in the <a href="<? echo $post_processing_forum_url ?>">Forums</a> to find someone to team up with for transcription.</p>
...
<p>If your common sense and personal judgement aren't helping you solve some particular problem, post your question in the <a href="<? echo $post_processing_forum_url ?>">Forums</a>.  Other po
