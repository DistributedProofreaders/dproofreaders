...
<h5>(Version 2.2; last updated May 1, 2003)</h5>
<br>
...
<ul>
<li><a href="#1-5">1-5. Choose a book and prepare it for proofing.</a> 	</li>
<li><a href="#6">6. Format the title page.</a> 	</li>
<li><a href="#7">7. Scan the book and correct obvious errors.</a> 	</li>
<li><a href="#8">8. Spell check.</a> 	</li>
<li><a href="#9">9. Search for -. Perform any other "paranoid "checks"
(ex. searching for Stealth Scannos).</a> 	</li>
<li><a href="#10">10. Search for *.</a> 	</li>
<li><a href="#11">11. Format the book.</a> 	</li>
<li><a href="#12">12. Run Gutcheck.</a> 	</li>
<li><a href="#13">13. Remove page markers.</a> 	</li>
<li><a href="#14">14. Rewrap lines.</a> 	</li>
<li><a href="#15-17">15-17. Search for hyphens adjacent to spaces, double
spaces, and spaces at the end of lines.</a> 	</li>
<li><a href="#18">18. Replace all HTML elements.</a> 	</li>
<li><a href="#19">19. Look the book over again.</a> 	</li>
<li><a href="#20">20. Upload book for verification.</a> 	</li>
</ul>
<br>
...
<ul>
<li>a <a href="#Editors">text editor</a>,	</li>
<li>a program capable of opening <a href="#Images">images</a>,	</li>
<li>a spell checker, and	</li>
<li><a href="#Gutcheck">Gutcheck</a>.	</li>
</ul>

<p>
There are other useful <a name="#Extras">programs</a> available
which are nice to have, but not essential.
</p>
<br>

<h4><a name="Selecting">
All right. I have everything I need to get started except a book.
Which one should I choose?</a></h4>

<p>
For your first project, it's a good idea to pick
a fiction book with a relatively small number of pages.
Here's why:
</p>

<ul>
    <li>
        fiction usually has fewer words per page than non-fiction
        and a more streamlined format,
        which means that it scans clearer
        and is unlikely to be riddled with OCR errors and inconsistent formatting;
    </li>
    <li>
        fiction generally lacks footnotes, tables, and other items
        which could be difficult for a new post-proofer to deal with;
        and 
    </li>
    <li>
...
Pick one with a title that is likely to be fiction.
"The Boy Scout Camera Club" is a good bet;
"Copyright Renewals" is not.
Download its text by going to its Book Options scrollbar
...
<p>
Check the
<a href="<? echo $projects_forum_url ?>">Project Questions and Comments Forum</a>
for your book's title to see what proofers have been saying about it.
Again, this might alert you of issues
which might make the work more difficult than you had realized.
</p>

<p>
When you have found a work that you want to do,
check it out by going to its Book Options scrollbar
and selecting Check Out Book.
...
It takes longer to complete the book
...
<li>Look for comments and questions proofers had while proofing your book in the
    <a href="<? echo $projects_forum_url ?>">Project Questions and Comments Forum</a>.
</li>
<br>
...
<li>If you are using a Mac, change the character set to Mac.
    ...
    You will need to convert the book back to ISO when it is complete.
</li>
<br>

<li>If the document is not displayed in a monospaced font,
    make this adjustment now.
    Also, if you are not saving the document as plain text,
    but as a Word document or some other file type,
...
<li><a name="6">Format the first page(s) to your liking.</a>
    ...
    Delete any copyright or publication information
    (unless you really want to keep them in),
    and space the rest in a way that is pleasing to your eye.
    If this section is in ALL CAPS,
    you can change it to Capitalized Text if you wish.
</li>
<br>

<li><a name="7">Scan the entire book for problems and formatting issues.</a>
    You will almost always run across things
    which obviously <i>just aren't right</i>,
    which can be corrected at this time.
    There are many other things that you can look for during this first pass.
    Here are a few things to watch for:
    <ul>
        <li>poetry, tables, and other areas
            which <b>must not</b> be re-wrapped
            (ie. where line breaks are important);
        </li>
        <li>punctuation in odd places (usually from specks on the scanned image)
            and dubious spellings;
        </li>
        <li>lines of asterisks:
            if you find one, it may be worth looking through the images
        ...
        <li>bad spacing:
            double spaces, indented paragraphs, wordsthatruntogether;
        </li>
    ...
    though some leave them in
    to make checking the text against the images easier.
...
<li><a name="8">Run a spell check.</a>
    ...
    may contain archaic and unusual spellings and words.
</li>
<br>
...
<li><a name="9">Search for -.</a>
    ...
    The purpose of this step is essentially
    to make sure that there are no em-dashes in the middle of words,
    no single dashes that should be em-dashes,
    and that all end-of-line hyphenation is fixed.
    <a href="#PRTK">PRTK</a> has a Dash Check feature
    which will list all words containing dashes
    so that you can look for oddities with ease.
    ...
    you must change all unbreaking hyphens back to regular hyphens at the end,
    ...
    since these conditions introduce a lot of errors
    that are difficult for proofers to spot.
    If this is your first book, you don't need to worry too much
    about these "bonus" checks, but once you learn the basics of proofing,
...
<li><a name="10">Search for *.</a>
    ...
    to mark potential problems,
    proofers may have used them to mark problems that they had
    and bring them to your attention.
    If you have left in the page markers, use them
    to guide you to the image containing the text that you are checking.
</li>
<br>
...
<li><a name="11">Format chapter headings and any subheadings
    ...
    two after the chapter title,
    and four between larger sections (eg.  Part 1 and 2),
    ...
    <p>
    Scan the book and make sure that
    all of the chapter headings and subheadings are there!
    Proofers sometimes remove these accidentally.
    If there is a table of contents, use it as a checklist;
    otherwise, refer to the images.
...
<li><a name="13">Remove page markers, either manually or with a tool or search.</a>
    Remove [Blank Page] tags as well.
</li>
<br>

<li><a name="14">Time to rewrap.</a>
    ...
    Be grateful that you chose a book with a low page count!</a>

    <p>
    If you have areas that you must not wrap, you must be more careful.
    In BBEdit, it is possible to rewrap a section by highlighting it
    and selecting Hard Wrap.
...
<li><a name="15-17">Search for space-hyphen and hyphen-space
    ...
    but you'll be able to identify them from their context.
</li>
<br>
...
<li>Remove end-of-line spaces by searching for spaces followed by returns
    and replacing them with returns only.
    Again, don't do a global replace.
    <a href="#PRTK">PRTK</a> has a feature
    which will remove end-of-line spaces automatically.
</li>
<br>

<li><a name="18">Find and replace
    all incidences of &lt;i&gt; and &lt;/i&gt; with _.</a>
    Make sure that the same number of &lt;i&gt; were replaced as &lt;/i&gt;.
    If there were more or less,
    some of the tags may not have been correctly typed,
    and you'll have to track them down.
    Try searching for &gt;, &lt;, and / to find them more quickly.
</li>
<br>

<li><a name="19">Give the whole thing a quick eyeball
    to make sure that all is well.</a>
</li>
<br>
...
<li><a name="20">Zip the finished product and upload it to the site.</a>
    ...
    an ASCII version for posting and an archive version for, well, archiving.
</li>
<br>
...
A quick-and-dirty Mac build
can be downloaded <a href="gutcheck-0-95.sit">here</a>.
...
<h4><a name="PRTK">PRTK</a></h4>

<p>
PRTK (Proofreader's Toolkit) removes the page markers for you
so that you needn't do it manually.
It may do other things as well, but I have never used it (help, please!).
Though it contains Gutcheck,
the version bundled with it is very old,
and it is recommended that you download the latest version.
PRTK is available
...
If you use Microsoft Word for any platform, you will be able to run a useful
...
<p>
You will need to be able to look at your book's scanned images at some point
in the post-proofing process.
...
<p>
Some people have recommended utilities
which allow you to see thumbnails of images without opening them,
...
<p>
Macros will perform certain repetitive post-proofing tasks for you to save time.
</p>
...
and adjust the margins to less than 75 characters
(I am less sure about these functions).
Please note that this macro will not work in Word 97 or older versions.
</p>

<p>
Naomi Parkhurst has written an
<a href="BBEditscript.sit">Applescript</a>
macro, which rewraps the text (including around poetry)
and removes superfluous spaces.
...
A more elaborate description of the script's abilites
...
<p>
Bill Keir has written a
<a href="http://users.hunterlink.net.au/%7Embbbk/RewrapIndent.zip">lisp script</a>
which will both rewrap and indent text automatically.
The user must insert certain tags so that the script knows when to indent
and when to rewrap.
These are explained on the script's page.
</p>
...
<p>
It is suggested that you should leave the footnotes
...
<p>
If the footnotes are so common that even this
would be highly disruptive to the reader,
...
Most post-proofers agree that the footnotes should not be simply inserted
into the text where they occur,
as this interferes with the rhythm of the poetry.
...
<h4>Should I leave in all of those [Illustration] tags?  What about the ones
with captions?</h4>
...
<p>
[Illustration] tags with captions
should be left in place for the reader to enjoy.
</p>
<br>
...
as it is altering the text of the original.
...
<p>
The proofers should have surrounded any verses of poetry
with the markers /* and */.
Remove the markers, and check against the original image
to make sure that the formatting is correct.
...
<p>
DO NOT WRAP LINES.
You will have to take special care when you rewrap the text
not to rewrap your poetry.
However, if a line is broken in two due to its length,
but it was not intended to be
(the second line of these is usually highly indented),
join the two parts of the line together.
If they still don't fit on one line,
break them and indent the second half heavily.
</p>
<br>
...
the book should be formatted as for occasional verses
(check the indentation, etc.)
Also, the poem(s) need not be indented two spaces by default,
as they are the main text, and don't need to stand out from it.
</p>

<p>
Books which are entirely comprised of poetry
do not need to have their lines rewrapped
...
<p>
<a href="<? echo $forums_url ?>/privmsg.php?mode=post&amp;u=3561">
bconstan</a>
has graciously offered to aid anyone who needs extra help
post-proofing poetry books.
...
rewrapping will destroy the format of the index.
Be careful!
</p>
<br>
...
<p>
You will have to move the text in the table around
...
<p>
DO NOT REWRAP LINES!
You don't want to destroy all of your hard work, now do you?
</p>
<br>
...
<ol>
    <li>Try your best.
        You may have to split the chart into multiple rows.
        Or you may come up with your own way to format the information
        in the troublesome chart.
        Be inventive.
    </li>
    <li>Give up.
        Mark the chart up as an [Illustration],
        use the title as the caption, and write it off.
        It's not ideal, but sometimes it's the only way.
    </li>
</ol>
...
<p>
In general, yes.
Keep all of the accented words (or symbols) as they are.
An ISO-8859-1 (also called Latin-1 or 8-bit ASCII) file
can be made which preserves them.
...
<p>
Some English-language texts contain just the occasional word
...
<h4>How do I handle footnotes, etc. in Greek, Russian, or other texts with
a non-Latin alphabet?</h4>
...
<p>
Many languages, like Arabic and Hebrew,
are difficult to transcribe without an intimate knowledge of the language.
...
It's too bad that the information will be lost,
but you've done the best you could.
</p>
<br>

<h4>My text has weird symbols in it (Zodiac signs, medical abbreviations,
etc.).  How do I mark these up?</h4>

<p>
If you are lucky, the proofer will have done some research
and found the meaning of the symbol for you.
However, often the proofer will mark the symbol with a *
and leave you with the legwork.  
</p>

<p>
If know what the symbol represents, write out its meaning,
eg. [Symbol: Jupiter].
Do not try to replicate the symbol itself in ASCII.
</p>

<p>
If you have never run across the symbol before, here are a few web pages
provided by proofers to help you:
<br>
<a href="http://www.lib.umich.edu/eebo/docs/dox/medical.html">
    Apothecaries'/Medical</a>
<br>
<a href="http://www.lib.umich.edu/eebo/docs/dox/alchem.html">
    Alchemical</a>
<br>
<a href="http://www.lib.umich.edu/eebo/docs/dox/moresyms.html">
    Astronomical</a>
<br>
<a href="http://www.lib.umich.edu/eebo/docs/dox/latabbrs.html">
    Latin Abbreviations</a>
<br>
<a href="http://www.symbols.com/graphicsearch.html">
    Graphic Search for Symbols</a>
</p>

<p>
This section has room to grow.
If you find any other good links, please
<a href="<? echo $forums_url ?>/privmsg.php?mode=post&amp;u=1674">
PM me</a>.
</p>
...
If this is the case,
try to determine the best meaning from the context of the symbol.
</p>
...
(ex. leave three lines blank when a new heading begins,
and only one for a new subheading).
However, some texts may have more than one layer of subheading.
In these cases, you will have to devise a markup
which is appropriate to the text.
You could indent subheadings a certain number of spaces
depending on their "layer", for example.
</p>
<br>
...
<p>
Yes, there are a few kinds of errors which often make it through
both rounds of proofing and into the final etext.
...
<p>
To check for random punctuation
caused by specks on the image that was OCRed,
search for the following things:
</p>

<ul>
<li>, or . followed immediately by a letter, 	</li>
<li>. followed by a space and a lowercase letter, 	</li>
<li>, followed by a space and an uppercase letter, 	</li>
<li>/ and /', which often occur instead of ," and .", 	</li>
<li>.' for ." (reverse these if your book uses single quotes as double quotes, 	</li>
<li>{ and } instead of [ and ], 	</li>
<li>standalone ' followed by a hard return, and 	</li>
<li>standalone symbols, like &amp;, $, ^, =, \, /, &Ccedil;, &Egrave;,
@, ~, `, #, %, =, +, and |, which can creep in. 	</li>
</ul>

<p>
A few errors are introduced by the HTML and other proofing markup
that DP uses for proofing.
To eliminate these, do the following:
</p>

<ul>
<li>before deleting the HTML elements,
    search for &lt;i&gt; followed by a space,
    and &lt;/i&gt; preceded by a space,
</li>
<li>[ and ], to make sure that all [Footnote] and [Illustration] tags
    are properly formatted, and
</li>
<li>after replacing the HTML elements,
    search for &gt;, &lt;, and /
...
<ul>
  <li>standalone 1 and O, which sometimes replace I and O, 	</li>
  <li>arid, for and, 	</li>
  <li>arc, for are, 	</li>
  <li>m, for in, 	</li>
  <li>yon, for you, 	</li>
  <li>modem, for modern, 	</li>
  <li>loth, for 10th, 	</li>
  <li>hut, for but, 	</li>
  <li>clay, for day, 	</li>
  <li>wen, for well, 	</li>
  ...
  <li>bo, for be, 	</li>
  <li>ho, for he, 	</li>
  <li>lie, for he and the, 	</li>
  <li>Alien, for Allen, 	</li>
  <li>coining, for coming, 	</li>
  <li>bad, for had, 	</li>
  <li>tiling, for thing, 	</li>
  <li>docs, for does, 	</li>
  <li>riot, for not, 	</li>
  <li>tho, for the, 	</li>
  <li>tum, for turn, 	</li>
  <li>cur, for our, 	</li>
  <li>ringer, for finger, 	</li>
  <li>mined, for ruined, 	</li>
  <li>carnage, for carriage, 	</li>
  <li>carne, for came, 	</li>
  <li>tile, for the, 	</li>
  <li>bat, for but, 	</li>
  <li>comer, for corner, 	</li>
  <li>44 and 11, for ", 	</li>
  <li>Borne, for Rome, 	</li>
  <li>ease, for case, 	</li>
  <li>lime, for time, 	</li>
  <li>Spam, for Spain, 	</li>
  <li>tram, for train, 	</li>
  <li>gram, for grain, 	</li>
  <li>guru, for gun, 	</li>
  <li>vas, for was, 	</li>
  <li>bum, for burn, 	</li>
  <li>j, for ;, 	</li>
  <li>tie, for the, 	</li>
  <li>gaming, for gaining, 	</li>
  <li>art, for act, 	</li>
  <li>ray, for my, 	</li>
  <li>eve(s), for eye(s), 	</li>
  <li>car, for ear, and 	</li>
  <li>cat, for eat. 	</li>
</ul>

<p>
A more complete, and constantly growing list is maintained by
<a href="<? echo $forums_url ?>/privmsg.php?mode=post&amp;u=6141">
big_bill</a>.
If you have found a "stealth scanno" which isn't on his lists, send it to him.
</p>

<p>
The latest version (presently 1.21) of big_bill's lists can be found here:
</p>

<a href="stealth_scannos_eng_common.txt">
    Common English Scannos</a>
<br>
<a href="stealth_scannos_eng_rare.txt">
    Rare English Scannos</a>
<br>
<a href="stealth_scannos_eng_suspect.txt">
    Theoretical (But as yet Unwitnessed) English Scannos</a>
<br>
<a href="stealth_scannos_fr_common.txt">
    Common French Scannos</a>
<br>
<a href="stealth_scannos_fr_rare.txt">
    Rare French Scannos</a>
<br>
<a href="stealth_scannos_fr_suspect.txt">
    Theoretical (But as yet Unwitnessed) French Scannos</a>
<br>
<a href="stealth_scannos_ger_common.txt">
    Common German Scannos</a>
<br>
<a href="stealth_scannos_ger_rare.txt">
    Rare German Scannos</a>
<br>
<a href="stealth_scannos_ger_suspect.txt">
    Theoretical (But as yet Unwitnessed) German Scannos</a>
<br>

<p>
The lists are plain text,
and could also be used by an adventurous programmer
...
go to your Post-Proofing page,
find the title of the book which you are returning,
...
<p>
Yes!
Feel free to make non-ASCII versions if you wish.
...
If they still have the text,
they may be able to clarify blurred or missing words,
or give you a scan for a missing page.
</p>

<p>
If they don't have the text, join
<a href="http://www.promo.net/pg/subs.html">gutvot-d</a>
...
so that they can find the damaged portions, correct them,
and send them back to you.
You could also do this process yourself
if the book exists in your local library.
</p>
<br>
...
You, as post-proofer, have a great deal of freedom
to decide how to handle particular formatting issues
and make global format changes.
</p>

<p>
If your common sense and personal judgement
aren't helping you solve some particular problem,
...
<a href="<? echo $forums_url ?>/privmsg.php?mode=post&amp;u=1674">
PM me</a>.
If it's a general or common enough question, I'll add it.
</p>
<br>
