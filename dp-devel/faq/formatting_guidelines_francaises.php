...
<TABLE cellSpacing=0 width="100%" border=0>
    ...
    <TD align=left bgColor=white>
      <UL>
        ...
        <UL>
          ...
          <LI><A
          href="#espace">T e 
          x t e&nbsp; e s p a cé (gesperrt) </A>
          <LI><A 
          href="#font_sz">Changement 
          de taille de police</A> 
          <LI><A 
          href="#word_caps">Mots 
          entièrement en majuscules ou minuscules</A> 
          <LI><A 
          ...
          supplémentaires, lignes et astérisques entre les paragraphes</A> 
          <LI><A
  ...
  <TR>
    ...
    <TD align=left bgColor=silver>
      <UL>
        <LI>Guides spécifiques pour livres particuliers </LI></UL></TD></TR>
  <TR>
    <TD width=1 bgColor=silver>&nbsp;<BR></TD>
    <TD align=left bgColor=white>
      <UL>
        ...
        <UL>
          <LI><A 
          href="#sp_ency">Encyclopédies</A> 

          <LI><A 
          href="#sp_poet">Poésie</A> 

          <LI><A 
          href="#sp_chem">Chimie</A> 
          [à compléter.] 
          <LI><A 
          href="#sp_math">Mathématiques</A> 
          [à compléter.] </LI></UL></LI></UL></TD></TR>
  <P>&nbsp; 
  <UL></UL></TD></TR>
  <TR>
    <TD width=1 bgColor=silver><BR></TD>
...
<P>Durant vos corrections, la règle principale à suivre est que le livre 
électronique final vu par un lecteur, potentiellement plusieurs années dans le 
futur, doit <B>transmettre l'intention de l'auteur de manière exacte.</B> 
<BR></P>
<P>Donc, la règle générale est “<I>Ne changez pas ce que l'auteur a écrit</I>”. 
...
<H3><A name=summary>Résumé des directives</A> </H3>
...
<P>Ce document a pour but de réduire les différences de formatage entre les 
...
clarifie ds points portant spécifiquement sur le projet. Cette discussion est 
...
summary="Page Headers and Footers" border=1>
  ...
  <TR align=left>
    <TD vAlign=top width="100%"><IMG height=850 alt="" 
      src="http://www.pgdp.net/c/faq/foot.png" width=500><BR></TD></TR>
  <TR>
...
<P>Introduisez 4 lignes vierges avant le “CHAPITRE XXX” (insérez ces lignes 
blanches même si le chapitre démarre sur une nouvelle page; il n'y a pas de 
pages sur un livre électronique, donc les lignes blanches sont nécessaires). 
Laissez ensuite une ligne blanche entre chaque partie de l'entête du chapitre, 
comme la description du chapitre, ou une citation en ouverture, etc. et laissez 
2 lignes vierges après, entre l'entête et le texte du chapitre.</P>
...
<H3><A name=sect_head>Entêtes de section</A></H3>
<P>Dans certains livres, les chapitres sont divisés en sections. Laissez les 
entêtes de section comme ils sont imprimés. Laissez deux lignes blanches avant 
cet entête, et une après (à moins que le chef de projet en ait décidé 
autrement). Si vous ne savez pas si un entête démarre un chapitre ou une
section, demandez dans la discussion de forum dédiée au projet, en précisant le 
numéro de page. </P>
<H3><A name=maj_div>Autres divisions dans les textes</A></H3>
<P>Les autres grandes divisions des textes (Préface, Avant-propos, Introduction, 
Prologue, Epilogue, Appendice, Références, Conclusion, Glossaire, Résumé, 
Remerciements, Bibliographie, etc.) seront traités comme des entêtes de 
chapitre. Quatre lignes blanches avant l'entête, et deux avant le début du 
texte. </P>
...
texte. Ce sont les "Sidenotes". Déplacez ces notes juste au-dessus du paragraphe 
auquel elles appartiennent. Une Sidenote est entourée par les marques de 
Sidenote: <TT>[Sidenote:&nbsp;</TT> avant et <TT>]</TT> après. Corrigez la note 
pour qu'elle ressemble au texte imprimé, en gardant les retours à la ligne, les 
italiques, etc. Laissez une ligne blanche après la note, pour qu'elle ne se 
mélange pas avec le paragraphe durant la phase de post-correction.</P>
<P>S'il y a plusieurs notes pour un même paragraphe, mettez-les l'une après 
l'autre au début du paragraphe. Séparez-les par des lignes blanches.</P>
<P>Si le paragraphe a commencé sur une page précédente, mettez la note en haut 
de la page et marquez-la avec une astérisque ( <TT>*</TT> ) de manière à ce que 
le post-correcteur puisse voir qu'elle appartient à la page précédente. De cette 
manière: <TT>*[Sidenote: le-commentaire-description]</TT> . Le post-correcteur 
déplacera la note à l'endroit approprié.</P>
<P>Parfois, le chef de projet vous demandera de placer la note à côté de la 
phrase à laquelle elle s'applique, et pas au début ou à la fin du paragraphe. 
Dans ce cas, ne les séparez pas par des lignes blanches.</P><!-- END RR -->
      ...
      <TABLE align=left summary="" border=0>
        ...
        <TR>
          <TD>
            ...
            Birlinger, &lt;i&gt;Volksthümliches aus<BR>Schwaben&lt;/i&gt; 
            ...
            Gebräuche<BR>aus Schwaben&lt;/i&gt; (Stuttgart, 1852), pp.<BR>423 
...
<P>Mettez une ligne blanche avant tout début de paragraphe, même si ce 
paragraphe démarre en haut d'une page. N'indentez pas le début des paragraphes 
...
post-correction. Mettez une ligne vide avant le /* et une autre après le */.</P>
<P>Voir aussi <A 
href="#bk_index">Index</A>, 
...
<P>Le texte pour une illustration doit être entouré de <TT>[Illustration: 
le-texte]</TT>. Gardez le texte comme il est imprimé, avec ses retours à la 
ligne, italiques, etc. </P>
<P>S'il n'y a pas de texte, indiquez juste <TT>[Illustration]</TT> à l'endroit 
où elle se trouve. Si l'illustration est au milieu d'un paragraphe ou sur le 
...
<P>2.La note est entourée par la marque de note <TT>[Footnote #:&nbsp;</TT> et 
<TT>]</TT>, avec le texte de la note entre les deux, et le numéro (ou la lettre) 
de la note à la place du signe #. Laissez le texte de la note tel qu'il est 
...
<P>Pour certains livres, le chef de projet vous demandera peut-être de mettre 
...
surtout si elle démarre au milieu d'une phrase ou d'un mot, c'est probablement 
la continuation d'une note de bas de page de la page précédente. Laissez-la au 
...
numéro de note). L'étoile indique que c'est une continuation de note, et attire 
l'attention du post-correcteur. </P>
<P>Si une note continue sur la page suivante (la page s'arrête avant la note), 
laissez la note à la fin de la page, et mettez un astérisque * là où la note 
s'arrête, comme ceci <TT>[Footnote 1: <FONT 
color=red>texte-texte-texte</FONT>]*</TT>. (Le * indique que la note s'arrête
...
summary="Footnote Examples" border=1>
  ...
  <TR>
    <TH vAlign=top align=left bgColor=cornsilk>Corrigé avec notes de bas de 
      page</TH></TR>
  <TR vAlign=top>
    <TD>
      <TABLE align=left summary="" border=0>
...
Traitez-les comme des notes hors-ligne. Quand vous voyez la référence dans le 
texte, entourez-la par des crochets. Si vous corrigez une des pages de fin, là 
où sont les notes,&nbsp; entourez la note par <TT>[Footnote #: <FONT 
color=red>(texte)</FONT>] </TT>en remplaçant le signe # par le numéro ou la 
marque de la note. Mettez une ligne blanche après chaque note, pour qu'elles 
apparaissent comme des paragraphes séparés.</P>
<P>Les notes sur de la poésie, ou sur des tables sont traitées comme les autres. 
Marquez la référence, et laissez les notes en bas de la page. Le post-correcteur 
décidera de leur emplacement final.&nbsp;</P>
<TABLE cellSpacing=0 cellPadding=4 width="100%" align=center summary=Footnotes 
border=1>
  <TBODY>
  <TR>
    <TH align=left bgColor=cornsilk>Poésie annotée</TH></TR>
  <TR>
    <TD vAlign=top>
      <TABLE align=left summary="" border=0>
        <TBODY>
...
border=1>
  ...
  <TR>
    ...
    <TH vAlign=top bgColor=cornsilk>Texte corrigé:</TH></TR>
  <TR>
...
<P>Le texte gras doit être marqué par <TT>&lt;b&gt;</TT> avant et <TT>&lt;/b&gt; 
</TT>après.</P>
<P>Les signes de ponctuation doivent être HORS des marques de "gras", à moins 
que ces signes ne soient dans une phrase ou une partie de phrase entièrement en 
gras. </P>
<P>Voyez l'exemple de la section <A 
href="#page_hf">Entêtes et 
bas de page</A> . </P>
<P>Certains chefs de projet peuvent spécifier dans les commentaires de projet 
que le texte gras doit être rendu par des majuscules. </P>
...
<TT>}</TT>. Mettez toujours le texte en exposant entre accolades, même si ce 
texte ne fait qu'un caractère. Ainsi: <BR>&nbsp; &nbsp; &nbsp; &nbsp; ... up to 
...
ailleurs. Indiquez l'indice en mettant un signe "souligné" <TT>_</TT> devant et 
...
<H3><A name=underl>Texte souligné</A> </H3>
<P>Marquez le texte souligné comme étant de l'<A 
href="#italics">Italique</A>, 
avec <TT>&lt;i&gt;</TT> et <TT>&lt;/i&gt;</TT>, à moins que les <A 
href="#comments">Commentaires 
de projet</A> spécifient l'utilisation de <TT>&lt;u&gt; </TT>et&nbsp; 
<TT>&lt;/u&gt; </TT>pour ce livre. Souligner était utilisé pour indiquer un 
italique quand l'éditeur était incapable d'italiciser un texte, par exemple, 
pour un document tapé à la machine. </P>
<H3><A name=espace>T e x t e&nbsp;&nbsp; e s p a c é (gesperrt)</A> </H3>
<P>Marquez ce texte en italique avec <TT>&lt;i&gt;</TT> et <TT>&lt;/i&gt; 
</TT>et enlevez les espaces en trop.&nbsp; Cette technique était utilisée pour 
...
les espaces supplémentaires peuvent ne pas être clairs sur certains écrans, avec
certaines fontes, quand les lecteurs liront le texte électronique. </P>
...
premier mot de chaque paragraphe en majuscule; ce doit être changé en un mot 
normal (première lettre en majuscule, le reste en minuscule). Donc "IL était une 
...
<H3><A name=mots_isoles>Mots isolés en bas de page</A> </H3>
<P>Effacez ces mots. Même si c'est la seconde partie d'un mot coupé.</P>
<P>Dans certains vieux livres, vous verrez un mot isolé en bas de page, près de 
...
<P>Cette section s'applique aux poèmes et aux épigrammes dans un livre qui n'est 
pas un livre de poésie. Pour les livres de poésie, voir les <A
href="http://www.pgdp.net/c/faq/doc-poet.php">Directives spéciales pour les 
livres de poésie.</A> </P>
<P>Marquez les poésies ou les épigrammes de sorte que le responsable puisse les 
trouver plus vite. Insérez une nouvelle ligne avec un <TT>/*</TT> au début de la 
poésie ou épigramme et une ligne séparée avec <TT>*/</TT> à la fin. Mettez une 
ligne blanche avant <TT>/*</TT> et une autre après <TT>*/</TT>. </P>
<P>Préservez l'indentation relative des vers les uns par rapport aux autres, en 
ajoutant 2,4,6... espaces avant le début du vers de façon à ressembler au texte 
imprimé. </P>
<P>Quand un vers est trop long pour la page, la plupart des éditions cassent le 
vers et impriment la fin sur une ligne séparée, vers la marge de droite. Dans 
ces cas-là, rejoignez les deux parties du vers de façon à ne former qu'une 
ligne. Les lignes de continuation commencent souvent par une minuscule, et 
apparaissent irrégulièrement alors que l'indentation normale apparaît 
régulièrement au cours du poème. </P>
<P>Ne passez pas votre temps à centrer les lignes de poésie, même si elles sont 
centrées sur la page originale. Calez le texte sur la marge de gauche (en 
indentant les vers les uns par rapport aux autres si nécessaire). </P>
...
<P>Regardez les <A 
href="#comments">commentaires 
de projet </A>pour des instructions spécifiques. Souvent, les livres de poésie 
ont des instructions spécifiques. Souvent, dans les livres composés entièrement 
ou principalement de poésie, ces instructions ne s'appliqueront pas. </P><!-- END RR -->
<TABLE cellSpacing=0 cellPadding=4 width="100%" align=center 
...
<P>Laissez les lettres non identées, comme vous le feriez pour des <A 
href="#para_space">paragraphes</A>. 
Au lieu d'indenter, insérez une ligne vierge avant le début de la lettre.</P>
<P>Marquez les entêtes et les fins de lettres (adresse, date, signature) avec un 
<TT>/*</TT> sur une ligne isolée avant, et <TT>*/ </TT>sur une ligne isolée 
après, comme si c'était de la poésie. Mettez une ligne blanche entre ces marques
et le reste du texte. De cette façon, ces lignes resteront isolées au cours de 
la phase d'assemblage à la post-correction. Ne les indentez pas, même si, sur 
l'original, elles sont indentées ou justifiées à droite. Calez-les sur la marge
  ...
  <TR>
    <TD vAlign=top width="100%">
      <TABLE align=left summary="" border=0>
        ...
        <TR>
          <TD>
            <P><TT>&lt;i&gt;John James Audubon to Claude François 
            Rozier&lt;/i&gt;</TT></P>
...
<P>Marquez ces listes comme de la poésie, avec une ligne <TT>/* </TT>avant et 
une ligne <TT>*/ </TT>après. Insérez une ligne blanche avant /* et une autre 
après */. Ainsi, le post-correcteur saura qu'il doit garder ces lignes séparées. 
Marquez ainsi des listes qui ne doivent pas être reformatées, comme des listes 
de questions/réponses, des ingrédients dans une recette, etc. </P><!-- END RR -->
      ...
      <TABLE align=left summary="" border=0>
        ...
        <TR>
          <TD><TT>/*<BR>Andersen, Hans Christian<BR>Bach, Johann 
            ...
            René<BR>Earhart, Amelia<BR>Einstein, Albert<BR>Freud, 
...
<P>Marquez les tables de manière à ce que le post-correcteur puisse les trouver, 
en les entourant de <TT>/*</TT> et <TT>*/</TT>, comme pour la <A 
href="#poetry">poésie</A>. 
Mettez une ligne blanche avant /* et une autre après */. Formatez les tables 
avec des espaces de manière à ce qu'elles ressemblent approximativement au 
tableau original. Ne faites pas de tableau plus large que 75 caractères. 
Les règles du projet Gutenberg ajoutent: "... sauf si vous ne pouvez pas
...
Regardez aussi la <A 
href="http://www.pgdp.net/phpBB2/viewtopic.php?t=4311">Galerie de tables </A>sur 
le forum. <BR></P>
<P><B>Les notes de bas de page</B> dans les tableaux doivent aller à la fin du 
tableau. Voyez <A 
href="#footnotes">notes de 
...
<TT>#/</TT> après. Laissez une ligne vide entre des marques et le reste du 
texte. </P>
...
lignes, parfois même plusieurs pages) incluses dans un livre. Elles sont souvent 
imprimées en caractères plus petits avec de plus grandes marges. </P><!-- END RR -->
<TABLE cellSpacing=0 cellPadding=4 width="100%" align=center 
...
<P>Certains livres mettent des guillements au début de chaque ligne dans une 
...
formatage. Mais des lignes vierges en bas de la page ne posent pas de problèmes,
ces dernières pouvant être supprimés facilement à la post-correction. </P>
...
paragraphes</A></H3>
<P>La plupart des livres commencent un paragraphe immédiatement après la fin du 
...
href="#chap_head">Entêtes de 
chapitre</A>, il est inutile d'utiliser la marque "rupture de pensée". </P>
<P>Dans l'interface de correction, vous pouvez copier/coller la marque de 
"rupture de pensée". </P><!-- END RR --><BR>
<TABLE cellSpacing=0 cellPadding=4 width="100%" align=center 
...
dans notre texte corrigé avec un codage spécifique, comme <TT>[)x]</TT> pour une 
...
remplacera ces combinaisons de caractères par le caractère correct (en Unicode 
par exemple). </P>
...
que A..Z). Grecs, Hébreux, Cyrilliques (utilisés pour le russe et autres langues 
slaves), ou Arabes. </P>
...
<H3><A name=page_ref>Références aux pages "cf. p. 123"</A> </H3>
<P>Laissez ces références telles qu'elles sont dans le texte, à moins que le 
responsable de projet ne vous dise le contraire dans les <A 
href="#comments">Commentaires 
de Projet</A>. </P>
<H3><A name=bk_index>Index</A> </H3>
<P>Laissez les numéros de page dans les index. Entourez l'index par deux lignes 
<TT>/*</TT> et <TT>*/</TT>, avec une ligne blanche avant <TT>/*</TT> et une 
autre après <TT>*/</TT>.</P>
<P>N'alignez pas les numéros les uns sur les autres (comme sur l'image): mettez 
simplement un point-virgule ou "deux points", puis le numéro de page.&nbsp;</P>
<P>Parfois, les index sont imprimés sur deux colonnes. L'espace est plus étroit, 
et une entrée donnée de l'index peut être coupée en deux lignes. Rejoignez les 
deux parties. Dans des index, avec cette règle, il est possible d'avoir une 
ligne très longue. Ce n'est pas grave, le post-correcteur le gèrera. </P>
<P>Mettez une ligne blanche entre chaque entrée de l'index.</P>
...
href="#sect_head">entêtes de 
section</A>, en les séparant par deux lignes blanches. 
<P>Les vieux livres imprimaient parfois le premier mot de chaque lettre de 
l'index entièrement en majuscule; changez ces mots pour que le style corresponde 
à celui utilisé dans le reste de l'index.</P><!-- END RR -->
<TABLE cellSpacing=0 cellPadding=4 width="100%" align=center 
summary="Rejoining Index Lines" border=1>
  <TBODY>
  <TR>
    <TH align=left bgColor=cornsilk>Texte scanné:</TH></TR>
  <TR>
    <TD vAlign=top>
      <TABLE align=left summary="" border=0>
        <TBODY>
...
<UL compact>
  <LI>Traitez les listes de personnages (Dramatis Personæ) comme des <A 
  href="#lists">listes</A>. 
  <LI>Insérez quatre lignes blanches avant le début d'un acte. 
  <LI>Insérez deux lignes blanches avant le début d'une scène. 
...
<TABLE cellSpacing=0 cellPadding=4 width="100%" align=center 
summary="Théâtre: exemple 1" border=1>
  <TBODY>
  <TR>
    <TH align=left bgColor=cornsilk>Exemple d'image:</TH></TR>
  <TR align=left>
...
name=sp_poet></A>Règles spécifiques pour livres spéciaux</H2>
<P>Les types de livres suivants ont des directives spécifiques, qui s'ajoutent 
aux présentes directives ou les remplacent. Ils sont souvent plus difficiles à 
corriger, et donc recommandés aux correcteurs expérimentés ou aux experts dans 
le domaine.&nbsp;</P>
<P>Cliquez sur un lien pour voir les directives sur un de ces types de 
livres.&nbsp;</P>
<UL compact>
  <LI><B><A href="http://www.pgdp.net/c/faq/doc-ency.php">Encyclopédies</A></B> 
  <LI><B><A href="http://www.pgdp.net/c/faq/doc-poet.php">Poésie</A></B> 
  <LI><B>Chimie [à compléter]</B> 
  <LI><B>Mathématiques [à compléter]</B> </LI></UL><BR>
<TABLE cellSpacing=0 width="100%" border=0>
  <TBODY>
  <TR>
...
<H3><A name=OCR_other>Problèmes d'OCR: tirets </A></H3>
<P>Les logiciels d'OCR ont fréquemment des problèmes avec les tirets et les 
traits d'union.Le texte passé à l'OCR a souvent un seul tiret pour un trait qui 
devrait en avoir 2. Voir les règles sur les <A 
...
lesquel un formule connue ou une équation peuvent être indiquées incorrectement. 
