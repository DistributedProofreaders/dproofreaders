...
<p> Some books will have short descriptions of the paragraph along the side of the text.
    ...
    Note: Sidenotes are connected to a paragraph, not a paragraph in themselves.  So do
    <i>not</i> leave a blank line after them.  </p>
<table width="100%" border="1"  cellpadding="4"
...
<p> These are numbers in the margin for each line -- common in older technical books.
    Remove all such line numbers from the text. Since the text will be reformatted in
    the e-book version, they will not be helpful.</p>
