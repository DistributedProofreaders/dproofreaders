...
$classic_grey['template_name'] = "Classic Grey";
$classic_grey['template_unix_name'] = "classic_grey";
$classic_grey['template_description'] = "A classic view with black, white, and grey";
$classic_grey['template_creator'] = "Joseph Gruber (USFJoseph)";
