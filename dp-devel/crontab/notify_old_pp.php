...
$projectslist\n\n 
If you haven't yet finished and wish to continue working on this book, please log in to www.pgdp.net and visit $url . This will update the status of the project. If you need help please forward a copy of this email (quoting the information on the book, above) with a brief description of the status to dphelp@pgdp.net.\n\n
If you have completed your work on the book, please log in to www.pgdp.net and visit $url. Select the 'Upload for verification' option and follow the prompts. You will be able to leave a message for the verifier during this process, if you have any special information or comments to pass on.\n\n
