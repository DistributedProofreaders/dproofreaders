...
$projectslist\n\n 
If you have completed your work on the book, please log in to www.pgdp.net and visit the Post Processing page at www.pgdp.net/c/tools/post_proofers/post_proofers.php and, under "Books I have checked out for Post-Processing" select the "Upload for verification" option and follow the prompts. You will be able to leave a message for the verifier during this process, if you have any special information or comments to pass on.\n\n
