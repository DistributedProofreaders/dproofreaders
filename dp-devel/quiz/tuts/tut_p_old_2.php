...
output_header(_('Old Texts Proofreading Tutorial -- Page 2'));

echo "<h2>" . _("Old Texts Proofreading Tutorial, Page 2") . "</h2>\n";
...
echo "<p><a href='../generic/main.php?type=p_old_2&quiz_id=OPQ'>" . _("Continue to quiz") . "</a></p>\n";
