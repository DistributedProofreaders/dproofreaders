...
output_header(_('Old Texts Proofreading Tutorial -- Page 1'));
...
echo "<h2>" . _("Old Texts Proofreading Tutorial, Page 1") . "</h2>\n";
echo "<h3>" . _("Long s") . "</h3>\n";
...
echo "<p><a href='../generic/main.php?type=p_old_1&quiz_id=OPQ'>" . _("Continue to quiz") . "</a></p>\n";
