...
echo "<ul>\n";
echo "<li>" . _("If a word begins with a capitalized vowel, the accents and breathing marks are often printed to the left of the letter, rather than above it.  If it has rough breathing, make the vowel lower case and capitalize the H: <tt>hÊraklês</tt> becomes <tt>Hêraklês</tt>.") . "</li>\n";
