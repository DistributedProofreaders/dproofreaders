...
echo "<p>" . _("There are usually two punctuation marks that differ from English: a question mark, and a medium stop. Modern printings of Greek often use a semicolon \";\" to indicate a question. Use a question mark \"<tt>?</tt>\" instead. A vertically centered single dot usually represents a medium stop; replace that with an English semicolon \"<tt>;</tt>\".") . "</p>\n";

echo "<p><a href='../generic/main.php?type=p_greek_4&quiz_id=GPQ'>" . _("Continue to quiz") . "</a></p>\n";
