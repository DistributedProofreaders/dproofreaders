...
output_header(_('Moderate Proofreading Tutorial -- Page 10'));

echo "<h2>" . _("Moderate Proofreading Tutorial, Page 10") . "</h2>\n";
...
echo "<p><a href='../generic/main.php?type=p_mod2_5&quiz_id=MPQ2'>" . _("Continue to quiz") . "</a></p>\n";
